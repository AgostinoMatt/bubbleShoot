...
namespace Mkey
{
    public class VideoPurchaser : MonoBehaviour
    {
        ...
        private void GoodPurchaseMessage(string prodId, string prodName)
        {
            ...
            {
                BubblesGuiController.Instance.ShowMessage("Succesfull!!!", prodName + " received successfull.", 3, null);
            }
        }
        ...
        private void FailedPurchaseMessage(string prodId, string prodName)
        {
            if (BubblesGuiController.Instance)
            {
                BubblesGuiController.Instance.ShowMessage("Sorry.", prodName + " - not received.", 3, null);
            }
        }
